...
#   sudo /opt/edge_ai_api/scripts/fix_freetype.sh
#
# ============================================
...
# Configuration
INSTALL_DIR="${INSTALL_DIR:-/opt/edge_ai_api}"
...
echo "  3. Verify library: ldd $INSTALL_DIR/bin/edge_ai_api | grep freetype"
echo ""
