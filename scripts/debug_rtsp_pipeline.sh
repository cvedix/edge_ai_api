...
RTSP_URL="rtsp://localhost:8554/live/camera_demo_sang_vehicle"
...
ping -c 2 -W 2 localhost > /dev/null 2>&1 && echo "✓ Server is reachable" || echo "✗ Server is not reachable"
nc -zv -w 2 localhost 8554 > /dev/null 2>&1 && echo "✓ RTSP port 8554 is open" || echo "✗ RTSP port 8554 is closed"
nc -zv -w 2 localhost 1935 > /dev/null 2>&1 && echo "✓ RTMP port 1935 is open" || echo "✗ RTMP port 1935 is closed"
echo ""
