...
void AICache::put(const std::string& key, const std::string& value, std::chrono::seconds ttl) {
...
std::string AICache::generateKey(const std::string& image_data, const std::string& config) {
