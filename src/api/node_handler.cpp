...
void NodeHandler::getNode(
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_ERROR << "[API] GET /v1/core/nodes/" << nodeId
...
void NodeHandler::createNode(
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_INFO << "[API] POST /v1/core/nodes - Success: Created node "
                << nodeId << " - " << duration.count() << "ms";
    }
...
void NodeHandler::updateNode(
  ...
  try {
    ...
    if (json->isMember("parameters") && (*json)["parameters"].isObject()) {
      ...
      if (isApiLoggingEnabled()) {
        PLOG_INFO << "[API] PUT /v1/core/nodes/" << nodeId
    ...
    if (isApiLoggingEnabled()) {
      PLOG_ERROR << "[API] PUT /v1/core/nodes/" << nodeId
                 << " - Exception: " << e.what() << " - " << duration.count()
                 << "ms";
    }
...
void NodeHandler::deleteNode(
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_ERROR << "[API] DELETE /v1/core/nodes/" << nodeId
                 << " - Exception: " << e.what() << " - " << duration.count()
                 << "ms";
    }
...
void NodeHandler::listTemplates(
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_INFO << "[API] GET /v1/core/nodes/templates - Success: "
    ...
    if (isApiLoggingEnabled()) {
      PLOG_ERROR << "[API] GET /v1/core/nodes/templates - Exception: "
...
void NodeHandler::getTemplate(
  ...
  if (isApiLoggingEnabled()) {
    PLOG_INFO << "[API] GET /v1/core/nodes/templates/" << templateId
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_ERROR << "[API] GET /v1/core/nodes/templates/" << templateId
                 << " - Exception: " << e.what() << " - " << duration.count()
                 << "ms";
    }
...
void NodeHandler::getStats(
  ...
  try {
    ...
    if (isApiLoggingEnabled()) {
      PLOG_INFO << "[API] GET /v1/core/nodes/stats - Success - "
                << duration.count() << "ms";
    }
