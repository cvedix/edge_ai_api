...
std::string SolutionConfig::getNodeName(const std::string& templateName, const std::string& instanceId) const {
...
std::string SolutionConfig::getParameter(const std::string& key,
