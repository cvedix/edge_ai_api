...
public:
  ...
  ADD_METHOD_TO(NodeHandler::getTemplate,
                "/v1/core/nodes/templates/{templateId}", Get);
  ...
  ADD_METHOD_TO(NodeHandler::handleOptions, "/v1/core/nodes/templates",
                Options);
  ADD_METHOD_TO(NodeHandler::handleOptions,
                "/v1/core/nodes/templates/{templateId}", Options);
