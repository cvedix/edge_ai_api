 ...
 */
class CreateInstanceHandler : public drogon::HttpController<CreateInstanceHandler> {
public:
    METHOD_LIST_BEGIN
        ADD_METHOD_TO(CreateInstanceHandler::createInstance, "/v1/core/instance", Post);
        ADD_METHOD_TO(CreateInstanceHandler::handleOptions, "/v1/core/instance", Options);
    METHOD_LIST_END
...
private:
     ...
     */
    bool parseRequest(const Json::Value& json, class CreateInstanceRequest& req, std::string& error);
