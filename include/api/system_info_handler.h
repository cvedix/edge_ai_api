 ...
 * 
 * Endpoints:
 * - GET /v1/core/system/info - Hardware information (CPU, GPU, RAM, Disk, Mainboard, OS, Battery)
 * - GET /v1/core/system/status - System status (CPU usage, RAM usage, load average, etc.)
 */
...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(SystemInfoHandler::getSystemStatus, "/v1/core/system/status", Get);
        ADD_METHOD_TO(SystemInfoHandler::handleOptions, "/v1/core/system/info", Options);
        ADD_METHOD_TO(SystemInfoHandler::handleOptions, "/v1/core/system/status", Options);
    METHOD_LIST_END
