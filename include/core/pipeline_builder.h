...
private:
   ...
   * @note DISABLED: cvedix_feature_encoder_node is abstract. Use
   * createSFaceEncoderNode or createTRTVehicleFeatureEncoderNode instead.
   */
   ...
   */
  std::string resolveModelByName(const std::string &modelName,
                                 const std::string &category = "face") const;
  ...
  listAvailableModels(const std::string &category = "") const;
};
