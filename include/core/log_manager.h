...
public:
     ...
     * @param max_disk_usage_percent Maximum disk usage percentage before cleanup (default: 85%)
     ...
     */
    static plog::RollingFileAppender<plog::TxtFormatter>* getAppender(Category category);
...
private:
    ...
    static std::unique_ptr<plog::RollingFileAppender<plog::TxtFormatter>> api_appender_;
    static std::unique_ptr<plog::RollingFileAppender<plog::TxtFormatter>> instance_appender_;
    static std::unique_ptr<plog::RollingFileAppender<plog::TxtFormatter>> sdk_output_appender_;
    static std::unique_ptr<plog::RollingFileAppender<plog::TxtFormatter>> general_appender_;
