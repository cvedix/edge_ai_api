...
private:
    ...
    static constexpr double FPS_REDUCTION_FACTOR = 0.9;  // Reduce by 10% when backpressure
    static constexpr double FPS_INCREASE_FACTOR = 1.05;   // Increase by 5% when stable
    static constexpr std::chrono::milliseconds ADAPTIVE_UPDATE_INTERVAL{1000};  // Update every 1 second
};
