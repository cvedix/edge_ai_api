...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(FontUploadHandler::renameFont, "/v1/core/fonts/{fontName}", Put);
        ADD_METHOD_TO(FontUploadHandler::deleteFont, "/v1/core/fonts/{fontName}", Delete);
        ADD_METHOD_TO(FontUploadHandler::handleOptions, "/v1/core/fonts/upload", Options);
    METHOD_LIST_END
