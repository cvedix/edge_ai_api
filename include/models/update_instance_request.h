 ...
 * Similar to CreateInstanceRequest but without solution (cannot change solution after creation)
 */
struct UpdateInstanceRequest {
    ...
    std::map<std::string, std::string> additionalParams;  // Only update keys that are provided
