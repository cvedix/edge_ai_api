...
public:
     ...
     * @param configPath Path to config.json file (optional, uses current path if empty)
     ...
     */
    void setGStreamerPipeline(const std::string& platform, const std::string& pipeline);
     ...
     */
    std::vector<std::string> getGStreamerCapabilities(const std::string& platform) const;
    
    /**
     * @brief Set GStreamer capabilities for a platform
     */
    void setGStreamerCapabilities(const std::string& platform, const std::vector<std::string>& capabilities);
     ...
     */
    void setGStreamerPluginRank(const std::string& pluginName, const std::string& rank);
     ...
     * @param path JSON path (e.g., "system.web_server", "gstreamer.decode_pipelines")
...
private:
     ...
     */
    Json::Value* getJsonValueByPath(const std::string& path, bool createIfNotExists = false);
    
    /**
     * @brief Parse JSON path and get parent and key
     */
    std::pair<Json::Value*, std::string> parsePath(const std::string& path) const;
};
