...
public:
    using StateChangeCallback = std::function<void(const std::string& instance_id, 
     ...
     */
    explicit WorkerSupervisor(const std::string& worker_executable = "edge_ai_worker");
    ~WorkerSupervisor();
     ...
     */
    IPCMessage sendToWorker(const std::string& instance_id, 
