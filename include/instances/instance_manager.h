...
public:
     ...
     * @return true if successful
     */
    virtual bool startInstance(const std::string& instanceId, bool skipAutoStop = false) = 0;
     ...
     * @return true if successful
     */
    virtual bool updateInstance(const std::string& instanceId, const Json::Value& configJson) = 0;
     ...
     */
    virtual std::optional<InstanceInfo> getInstance(const std::string& instanceId) const = 0;
     ...
     */
    virtual std::optional<InstanceStatistics> getInstanceStatistics(const std::string& instanceId) = 0;
     ...
     * @return JSON config
     */
    virtual Json::Value getInstanceConfig(const std::string& instanceId) const = 0;
     ...
     * @return true if successful
     */
    virtual bool updateInstanceFromConfig(const std::string& instanceId, const Json::Value& configJson) = 0;
