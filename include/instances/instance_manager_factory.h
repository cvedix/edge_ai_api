...
public:
     ...
     * @param pipelineBuilder Pipeline builder reference (only used for IN_PROCESS)
     ...
     */
    static std::unique_ptr<IInstanceManager> create(
     ...
     */
    static std::unique_ptr<IInstanceManager> createInProcess(
        SolutionRegistry& solutionRegistry,
        PipelineBuilder& pipelineBuilder,
        InstanceStorage& instanceStorage);
     ...
     */
    static std::unique_ptr<IInstanceManager> createSubprocess(
        SolutionRegistry& solutionRegistry,
        InstanceStorage& instanceStorage,
        const std::string& workerExecutable = "edge_ai_worker");
